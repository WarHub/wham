...
significant design choices in the wham project.

| ADR | Title | Status |
|-----|-------|--------|
| [0001](0001-roslyn-inspired-compilation-model.md) | Roslyn-inspired compilation and symbol model | Accepted |
| [0002](0002-immutable-source-trees.md) | Immutable source trees and operation-based editing | Accepted |
