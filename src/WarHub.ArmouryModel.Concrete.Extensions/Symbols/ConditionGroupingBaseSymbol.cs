...
internal abstract class ConditionGroupingBaseSymbol : ConditionBaseSymbol, IConditionSymbol
{
    ...
    internal sealed class ConditionGroupSymbol : ConditionGroupingBaseSymbol, INodeDeclaredSymbol<ConditionGroupNode>
    {
    ...
    internal sealed class ModifierConditionGroupSymbol : ConditionGroupingBaseSymbol, INodeDeclaredSymbol<ModifierBaseNode>
    {
