...
internal static class ErrorSymbols
{
    ...
    internal sealed record ErrorPublicationSymbol : ErrorResourceDefinitionSymbol, IPublicationSymbol
    {
    ...
    internal sealed record ErrorCharacteristicSymbol : ErrorResourceEntrySymbol, ICharacteristicSymbol
    {
        string ICharacteristicSymbol.Value => string.Empty;
    }

    internal sealed record ErrorProfileSymbol : ErrorResourceEntrySymbol, IProfileSymbol
    {
    ...
    internal sealed record ErrorRuleSymbol : ErrorResourceEntrySymbol, IRuleSymbol
    {
        string IRuleSymbol.DescriptionText => string.Empty;
    }

    internal sealed record ErrorCategoryEntrySymbol : ErrorContainerEntrySymbol, ICategoryEntrySymbol
    {
    ...
    internal sealed record ErrorForceEntrySymbol : ErrorContainerEntrySymbol, IForceEntrySymbol
    {
    ...
    internal sealed record ErrorSelectionEntrySymbol : ErrorSelectionEntryContainerSymbol, ISelectionEntrySymbol
    {
        SelectionEntryKind ISelectionEntrySymbol.EntryKind => SelectionEntryKind.Upgrade;
    }

    internal sealed record ErrorSelectionEntryGroupSymbol : ErrorSelectionEntryContainerSymbol, ISelectionEntryGroupSymbol
    {
    ...
    internal sealed record ErrorGamesystemSymbol : ErrorCatalogueBaseSymbol
    {
    ...
    internal sealed record ErrorCatalogueSymbol : ErrorCatalogueBaseSymbol
    {
